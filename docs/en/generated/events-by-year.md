...
<section class="archive-page-intro" markdown>
  ...
  <h1>By Year</h1>
  <p>Generated from `data/events.yml`, this page groups events by year for annual reviews and staged revisions.</p>
</section>
<section class="archive-index-panel" data-archive-filter>
  <div class="archive-index-panel__summary">
    <span class="archive-index-panel__label">Year groups</span>
    <strong>5</strong>
    <p>Split events by year to review phases and locate revision ranges.</p>
  </div>
  <div class="archive-index-panel__tools">
    <label class="archive-index-search"><span>Search this page</span><input type="search" data-archive-filter-input placeholder="Filter by year, event, person, place, or source"></label>
