...
<section class="archive-page-intro" markdown>
  ...
  <h1>全量大事记</h1>
  <p>本页由 `data/events.yml` 自动生成，集中展示已编目事件的时间、人物、地点、来源和可信度。</p>
</section>
<section class="archive-index-panel" data-archive-filter>
  <div class="archive-index-panel__summary">
    <span class="archive-index-panel__label">结构化事件</span>
    <strong>5</strong>
    <p>按时间、类别、地点、来源与可信度扫描全部记录。</p>
  </div>
  <div class="archive-index-panel__tools">
    <label class="archive-index-search"><span>本页检索</span><input type="search" data-archive-filter-input placeholder="筛选时间、事件、人物、地点或来源"></label>
...
<p class="archive-update-note">修改结构化事件后，运行 <code>python scripts/build_indexes.py</code> 更新。</p>
