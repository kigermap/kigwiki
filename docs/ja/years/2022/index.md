...
2026年9月5日の再確認では、引用した FGO、Inside Games、キグルミwasshoi!、着ぐFesta、Doll Weekend の各ページを引き続き公開状態で確認できた。Doll Weekend の現行イベントページには DW5〜DW8 の正確な開催日は記載されていない。今回追加した Bilibili メタデータが示すのは公開動画の投稿日と、DW7についてはイベントがすでに終了していた期限だけであり、主催者が公開していない開催日の代わりにはならない。
...
**現場性。** 公式の FGO kigurumi、ホテル型のキグルミwasshoi!、WCS の公共空間、Doll Weekend の海辺と花火のいずれにおいても、2022 年は一つの点を繰り返し示しました。kigurumi の核となる魅力は現場で生まれるということです。画面は映像を広められますが、キャラクターの身体の存在、移動、手を振ること、集合写真、体力と身体的境界は、いずれも現実の空間を必要とします。
