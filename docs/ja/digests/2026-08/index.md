...
date: "2026-08-26"
language: "ja"
status: "2026-08-26まで再確認・7月からの状態変化のみ記録"
---

# 2026年8月 Kigurumi 公開資料ダイジェスト

> 本ページは月次収集であり、2026年の確定編年ではない。検索期限は **2026年8月26日（Asia/Shanghai）**。継続イベントは状態だけを更新し、7月に整理した規則と予告を複製しない。
...
| 7月31日-8月2日 / 公式日付期間は経過、実施完了は未確認 | 日本・名古屋 | 編年、啓発、礼儀、安全 | WCS 2026 の公式終了日は8月2日。8月26日の再確認時点でも、主催者による検証可能な完了記録はない | 高 |

### 8月21-25日：DW14 の公開記録が3日間から具体的な演目へ拡張

Doll Weekend 公式ページは、DW14 を2026年8月21-23日に中国・広東省恵州で開催し、テーマを「夢回嶺南」とする情報を引き続き掲載している。8月26日の再確認時点でも購入リンクと DW14 の「火爆征集中」表示が残り、閉幕後の状態更新はまだ行われていない。[^dw14] 23日までに確認した4投稿者の初日短編・長時間記録は、Day1 の公開参加記録として引き続き有効である。[^dw14-day1]
...
WCS 公式ページと構造化イベントデータは、2026年7月31日から8月2日までの名古屋日程を引き続き掲載し、`endDate` は8月2日、状態は `EventScheduled` のままである。[^wcs] 8月26日の再確認でも状態欄または主催者総括の更新を確認できなかったため、確定できるのは公式日付期間が過ぎたことまでである。これは**状態の訂正**であり、二件目のイベント記録ではなく、日付だけで全プログラムの実施を証明できない。
...
| 分野 | 8月26日の再確認判断 | 処理 |
| --- | --- | --- |
| 編年史 | DW14 は3日間をカバーし、具体的な演目記録も現れた。WCS の実施完了は引き続き未確認 | 元イベントの状態を更新し、重複追加しない |
| 日常 / 雑談 | 公共空間の投稿と kigurumi タグを持つ短い話題を追加 | 公開の手掛かりとして収録し、身元、撮影日、心理的結論は推定しない |
...
今回の再確認では既存の3日間記録に DW14 の具体的な演目を加え、公共空間の日常と雑談の手掛かりも追加した。いずれも月次ダイジェスト内で扱う規模であり、サイト全体の新分野を設ける根拠にはならない。WCS の終了記録、DW14 の公式演目表、頭殻の素材資料、方法と標本を持つ社群研究が確認できた場合は、重複する日次ページではなく元の出典の流れを更新する。
