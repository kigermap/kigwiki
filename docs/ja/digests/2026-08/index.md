...
date: "2026-08-27"
language: "ja"
status: "2026-08-27まで再確認・7月からの状態変化のみ記録"
---

# 2026年8月 Kigurumi 公開資料ダイジェスト

> 本ページは月次収集であり、2026年の確定編年ではない。検索期限は **2026年8月27日（Asia/Shanghai）**。継続イベントは状態だけを更新し、7月に整理した規則と予告を複製しない。
...
| 7月31日-8月2日 / 公式日付期間は経過、実施完了は未確認 | 日本・名古屋 | 編年、啓発、礼儀、安全 | WCS 2026 の公式終了日は8月2日。8月27日の再確認時点でも、主催者による検証可能な完了記録はない | 高 |

### 8月21-25日：DW14 の公開記録が3日間から具体的な演目へ拡張

Doll Weekend 公式ページは、DW14 を2026年8月21-23日に中国・広東省恵州で開催し、テーマを「夢回嶺南」とする情報を引き続き掲載している。8月27日の再確認時点でも購入リンクと DW14 の「火爆征集中」表示が残り、閉幕後の状態更新はまだ行われていない。[^dw14] 23日までに確認した4投稿者の初日短編・長時間記録は、Day1 の公開参加記録として引き続き有効である。[^dw14-day1]
...
振り返りのタイトルには「千人」、説明には「過去最大」と次回地域への言及があるが、いずれも投稿者の表現である。8月27日の再確認でも Doll Weekend 公式ページは DW14 を「募集中」と表示し、閉幕統計や次回告知を出していない。[^dw14] したがって公式参加者数、記録、確定日程として扱わない。
...
Bilibili 公開メタデータは「佩戴会眨眼的头壳+内部细节展示」を2026年8月23日17:02（Asia/Shanghai）、投稿者を真爱你的辣条、長さを4分とし、`kigurumi` と `头壳` のタグを付けている。[^bili-blink] 題名とタグから当月の工房 / 制作・啓発資料に分類でき、8月14日の完成品短編にはなかった装着と内部構造の視点もある。

説明欄はハイフンだけで、素材、まぶたの駆動、制御方法、制作者、独自構造かどうかは示さない。本ページは「新規技術展示」としてのみ記録し、チュートリアル、製品評価、技術上の初出には拡張しない。瞬きする頭殻という概念自体も当月初出とはしない。
...
WCS 公式ページと構造化イベントデータは、2026年7月31日から8月2日までの名古屋日程を引き続き掲載し、`endDate` は8月2日、状態は `EventScheduled` のままである。[^wcs] 8月27日の再確認でも状態欄または主催者総括の更新を確認できなかったため、確定できるのは公式日付期間が過ぎたことまでである。これは**状態の訂正**であり、二件目のイベント記録ではなく、日付だけで全プログラムの実施を証明できない。
...
- Doll Weekend × KIGURUMI 三都市撮影企画は7-8月の項目として収録済み。8月23日も公式ページは進行中と表示し、画像追加は同一企画の更新として扱う。[^dwkig]
...
| 分野 | 8月27日の再確認判断 | 処理 |
| --- | --- | --- |
| 編年史 | DW14 にスタッフの設営 / 撤収自己記録が加わったが、主催閉幕統計はない。WCS の実施完了も未確認 | 元イベントの状態を更新し、重複追加しない |
| 日常 / 雑談 | 頭殻開封と失敗実験の振り返りを、既存の公共空間日常・話題信号に追加 | 身元、撮影日、一般的結論を推定せず公開範囲を収録 |
| 工房 / 手作業 | 開封と失敗した互換実験を追加。瞬き頭殻展示には引き続き素材説明がない | 構造、素材、先行性を推定せず成果・振り返り信号として収録 |
| 百科 / 啓発 | DW14 後方支援タグと頭殻記録は手掛かりだが、メタデータだけでは一覧や教程にならない | 根拠の範囲を記録 |
| 礼儀 / 安全 | DW14 後方支援短編は検証可能な手順を示さず、WCS 規則にも実質更新なし | 既存記録へ接続し、新規規範を作らない |
| 学術 | 8月の直接関連新研究を確認できず | 収録しない |

今回の再確認では既存の DW14 出典の流れにスタッフ後方支援記録を加え、頭殻開封と失敗実験の振り返りも追加した。いずれも月次ダイジェスト内で扱う規模であり、サイト全体の新分野を設ける根拠にはならない。WCS の終了記録、DW14 の公式閉幕統計または演目表、頭殻の素材 / 構造資料、方法と標本を持つ社群研究が確認できた場合は、重複する日次ページではなく元の出典の流れを更新する。
...
[^bili-blink]: 真爱你的辣条「佩戴会眨眼的头壳+内部细节展示」Bilibili, 2026年8月23日、<https://www.bilibili.com/video/BV1Dr8x6NEkd/>; 公開メタデータ・タグ: <https://api.bilibili.com/x/web-interface/view?bvid=BV1Dr8x6NEkd>、<https://api.bilibili.com/x/tag/archive/tags?bvid=BV1Dr8x6NEkd>
