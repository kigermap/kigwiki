<section class="archive-page-intro" markdown>
  ...
  <h1>Обзор хроники</h1>
  <p>Раздел хроники собирает события сообщества в хронологическом порядке. Мероприятия, выставки, производственные практики, интервью, обновления архива и важные совместные работы сначала получают здесь год и место.</p>
</section>

<section class="archive-section" markdown>
  <p class="archive-kicker">Chronicle Design</p>
  <h2>Форма записи</h2>
  <p>Каждая запись должна по возможности содержать год, дату, название события, место, участников, источники, границы публичности, уровень надежности и вопросы для проверки.</p>
  <div class="archive-feature-grid archive-feature-grid--compact">
    <article class="archive-feature"><span class="archive-feature__icon">Хр</span><h3>Ключевые события</h3><p>Фиксирует узлы, влияющие на развитие сообщества, организацию, публичный показ и работу с источниками.</p></article>
    <article class="archive-feature"><span class="archive-feature__icon">Тм</span><h3>Темы через годы</h3><p>Для долгих процессов указывает начало, ход, влияние и источники.</p></article>
    <article class="archive-feature"><span class="archive-feature__icon">Инд</span><h3>Индекс годов</h3><p>Связывает годы, места, людей и источники для поиска и цитирования.</p></article>
  </div>
</section>
...
<section class="archive-section" markdown>
  ...
  <div class="archive-feature-grid archive-feature-grid--compact">
    <article class="archive-feature"><span class="archive-feature__icon">06</span><h3>Хроника Kigurumi 2006 года</h3><p>Правила Tokyo Game Show о крупных kigurumi, назначенной раздевалке, гардеробе, проверке костюмов и согласии на съемку с сохранением пробела участия.</p><a href="../years/2006/">Открыть год</a></article>
    <article class="archive-feature"><span class="archive-feature__icon">07</span><h3>Хроника Kigurumi 2007 года</h3><p>Подтверждены даты, место и закрытие Tokyo Game Show 2007; общие публичные правила связаны с томом 2006 года без повтора.</p><a href="../years/2007/">Открыть год</a></article>
    <article class="archive-feature"><span class="archive-feature__icon">08</span><h3>Хроника Kigurumi 2008 года</h3><p>Даты, место и завершение Tokyo Game Show 2008 с явным пробелом в доказательствах участия и специальных правил.</p><a href="../years/2008/">Открыть год</a></article>
    <article class="archive-feature"><span class="archive-feature__icon">09</span><h3>Хроника Kigurumi 2009 года</h3><p>План проверки багажа Tokyo Game Show 2009, швейные принадлежности и срок оформления раздевалки; общие правила перенесены в 2006 год.</p><a href="../years/2009/">Открыть год</a></article>
    <article class="archive-feature"><span class="archive-feature__icon">10</span><h3>Хроника Kigurumi 2010 года</h3><p>Новая cosplay-программа Tokyo Game Show, раннее переодевание в зале 7 и вечернее продление; базовые правила восходят к 2006 году.</p><a href="../years/2010/">Открыть год</a></article>
    <article class="archive-feature"><span class="archive-feature__icon">11</span><h3>Хроника Kigurumi 2011 года</h3><p>Уникальный переход раздевалки и гардероба Tokyo Game Show из зала 7 в зал 2 без повторения общих правил.</p><a href="../years/2011/">Открыть год</a></article>
