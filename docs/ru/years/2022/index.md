...
При повторной проверке 5 сентября 2026 года процитированные страницы FGO, Inside Games, キグルミwasshoi!, 着ぐFesta и Doll Weekend оставались в открытом доступе. На текущих страницах Doll Weekend по-прежнему нет точных дат DW5–DW8. Дополнительные метаданные Bilibili устанавливают только даты публикации видео и, для DW7, верхнюю временную границу, к которой событие уже завершилось; они не заменяют дату, которую организатор не опубликовал.
