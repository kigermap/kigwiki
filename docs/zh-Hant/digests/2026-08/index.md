...
date: "2026-08-24"
language: "zh-Hant"
status: "滾動複核至 2026-08-24；只記錄相對 7 月的新狀態"
---

# 2026 年 8 月 Kigurumi 公開資料摘要

> 本頁是月度採集，不是 2026 年度編年定稿。檢索截止日期為 **2026 年 8 月 24 日（Asia/Shanghai）**。同一活動只記錄狀態變化，不複製 7 月已整理的規則和預告。
...
| 7 月 31 日-8 月 2 日 / 官方日期窗口已過，實際完成待核 | 日本名古屋 | 編年、科普、禮儀、安全 | WCS 2026 官方結束日期為 8 月 2 日；8 月 24 日複核時仍無可核驗的主辦方完成記錄 | 高 |

### 8 月 21-24 日：DW14 公開記錄從首日擴展到三日與會後回顧

Doll Weekend 官方頁仍列出 DW14 於 2026 年 8 月 21-23 日在廣東惠州舉行，主題為「夢回嶺南」；8 月 24 日複核時，頁面仍顯示購票入口並標註「火爆征集中」，所以頁面尚未完成閉幕後更新。[^dw14] 23 日前取得的四位發布者首日短片與長時錄影繼續證明 Day1 已有公開參與記錄。[^dw14-day1]
...
### 8 月 23 日：可眨眼頭殼出現佩戴與內部展示

Bilibili 公開資料把《佩戴會眨眼的頭殼+內部細節展示》的發布時間標為 2026 年 8 月 23 日 17:02（Asia/Shanghai），發布者為真愛你的辣條，長 4 分鐘，標籤包含 `kigurumi` 與 `頭殼`。[^bili-blink] 標題與標籤足以把它歸入當月工坊 / 手工和科普線索，也比 8 月 14 日的成品短片多出佩戴與內部結構視角。

影片簡介只有連字號，公開資料沒有說明材料、眼瞼驅動、控制方式、製作者或是否為原創結構。本頁只記錄「新發布的技術展示」，不擴寫成教程、產品評測或技術首創；可眨眼頭殼概念也不標為當月首次出現。
...
WCS 官方頁及其結構化事件資料繼續列出 2026 年 7 月 31 日至 8 月 2 日的名古屋日程，`endDate` 為 8 月 2 日，狀態仍標為 `EventScheduled`。[^wcs] 8 月 24 日複核未發現狀態欄位或官方總結更新，因此只能確認官方日期窗口已經過去；這是一項**狀態校勘**，不是第二個活動條目，也不能單憑日期證明所有節目實際完成。

截至檢索時，本站沒有找到足以確認全部活動已完成的主辦方總結或獨立回顧，故不寫成「已舉行完畢」。遮面服裝、攝影同意和熱風險規則已在[2026 年 7 月摘要](../2026-07/index.md)完整整理，本頁不再複述。

## 已跟蹤但不重複

- Doll Weekend × KIGURUMI 三城攝影活動已作為 7-8 月項目收錄；8 月 23 日官方頁仍標為「進行中」，已有圖集屬於同一項目更新，不拆成新節點。[^dwkig]
...
| 領域 | 8 月 24 日複核判斷 | 處理 |
| --- | --- | --- |
| 編年史 | DW14 公開記錄已覆蓋三個日期；WCS 實際完成仍待核 | 更新原事件狀態，不建立重複條目 |
| 日常 / 雜談 | DW14 三日回顧與會後告別、8 月 14 日成品展示均可核驗 | 作為當月公開日常收錄 |
...
本次複核把 DW14 從「只有首日記錄」更新為「公開記錄覆蓋三日」，並新增一條可獨立引用的頭殼技術展示；這些內容仍適合放在月度摘要，不足以建立新的站點領域板塊。若後續出現 WCS 完成報告、DW14 官方回顧或頭殼材料與製作說明，將沿同一來源鏈更新，而不是另建重複日頁。
...
[^bili-blink]: 真愛你的辣條, “佩戴會眨眼的頭殼+內部細節展示,” Bilibili, August 23, 2026, <https://www.bilibili.com/video/BV1Dr8x6NEkd/>; public metadata and tags: <https://api.bilibili.com/x/web-interface/view?bvid=BV1Dr8x6NEkd> and <https://api.bilibili.com/x/tag/archive/tags?bvid=BV1Dr8x6NEkd>
