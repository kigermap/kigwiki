...
PAGE_DESCRIPTIONS = {
    ...
    "/years/2011/": "2011 年 Kigurumi 编年史，整理东京电玩展 2 号馆更衣寄存、早间换装及以墙为背景的摄影边界。",
    ...
    "/zh-Hant/years/2011/": "2011 年 Kigurumi 編年史繁體中文版，整理東京電玩展 2 號館更衣寄存、早間換裝及以牆為背景的攝影邊界。",
    ...
    "/en/years/2011/": "The 2011 Kigurumi Chronicle covers Tokyo Game Show's Hall 2 changing workflow, early access, and wall-background photo boundary.",
    ...
    "/ja/years/2011/": "2011年 Kigurumi 編年史。東京ゲームショウの2ホール更衣・クローク、早朝更衣、壁を背景にする撮影境界を扱います。",
    ...
    "/ru/years/2011/": "Хроника Kigurumi 2011 года: раздевалка и гардероб зала 2 Tokyo Game Show, ранний доступ и стена-фон для съемки.",
